...
import { Activity, Check, CircleOff, Copy, Cpu, Download, Github, LoaderCircle, MonitorCog, Plus, Stethoscope, TerminalSquare, Trash2, X } from "lucide-react";
...
export default function WorkersPage() {
  ...
  const removeWorker = trpc.buildforge.workers.delete.useMutation({
    onSuccess: () => {
      void utils.buildforge.workers.list.invalidate();
      void utils.buildforge.dashboard.summary.invalidate();
